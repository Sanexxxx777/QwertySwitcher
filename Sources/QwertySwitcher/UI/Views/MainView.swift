    ...
    private var logsContent: some View {
        VStack(spacing: 0) {
            SettingToggleRow(
                icon: "text.magnifyingglass",
                title: "Подробный лог",
                subtitle: "писать в лог каждое слово и коды нажатых клавиш",
                help: "Включайте, если нужно прислать диагностику или разобрать ошибку. "
                    + "Пока выключен, нажатия клавиш на диск не попадают. Включённым он пишет "
                    + "и коды клавиш — файл доступен только вашей учётной записи, а кнопка "
                    + "«Собрать отчёт» эти строки вырезает.",
